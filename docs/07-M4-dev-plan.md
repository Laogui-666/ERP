# 华夏签证 ERP - M4 实时通信全知开发手册

> **文档版本**: V10.0
> **创建日期**: 2026-03-28
> **更新日期**: 2026-03-30 02:30（**M6 全部完成**，M1~M6 六个里程碑全部 100%，140 源文件 / ~18,500 行 / 45 API 路由 / 93 测试用例）
...
| 批次 | 内容 | 工时 | 前置 | 状态 |
|---|---|---|---|---|
| **批次 1** | 数据层：Schema + 迁移 + 类型 + 种子 + RBAC + JwtPayload + ChatRoom 创建 + 系统消息工具 + 事件总线 | 4h | — | ✅ 完成 |

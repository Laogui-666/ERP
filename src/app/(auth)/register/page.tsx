...
export default function RegisterPage() {
  ...
  const fields: { key: string; label: string; placeholder: string; type: string; icon: React.ReactNode; pattern?: string }[] = [
    {
      key: 'companyName', 
      label: '公司名称', 
      placeholder: '请输入公司名称', 
    ...
    <div className="flex min-h-screen items-center justify-center px-4 bg-gradient-to-br from-morandi-light via-morandi-cream to-morandi-blush">
      <div className="relative z-10 w-full max-w-[420px]">
            ...
            <div className="space-y-6">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ ...liquidSpringConfig.medium, delay: 1 }}
                >
                  <LiquidButton
                    type="submit"
                    disabled={loading}
        ...
        <motion.p 
          ...
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ ...liquidSpringConfig.gentle, delay: 1.1 }}
        >

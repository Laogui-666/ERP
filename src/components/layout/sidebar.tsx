    ...
    <aside className="glass-sidebar fixed left-0 top-0 h-full w-64 z-40 flex flex-col">
      ...
      <div className="h-16 flex items-center px-6 border-b border-white/5">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[var(--color-primary)]/30 to-[var(--color-accent)]/20 flex items-center justify-center">
          ...
          <span className="text-lg font-bold text-[var(--color-text-primary)] tracking-tight">Visa ERP</span>
        </div>
      </div>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? 'bg-[var(--color-primary)]/15 text-[var(--color-text-primary)] shadow-lg shadow-[var(--color-primary)]/5'
      ...
      <div className="p-4 border-t border-white/5">
        <div className="glass-card-static px-3 py-2.5 rounded-xl">
          <div className="text-xs text-[var(--color-text-placeholder)] mb-1">
            {user?.company?.name ?? '未关联公司'}
          </div>
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-full bg-[var(--color-primary)]/20 flex items-center justify-center text-xs text-[var(--color-primary-light)] font-medium">
              {user?.realName?.[0] ?? '?'}
            </div>
            <div className="flex-1 min-w-0">
              <div className="text-sm text-[var(--color-text-primary)] font-medium truncate">{user?.realName ?? '未知'}</div>
            </div>
          </div>
        </div>
      </div>

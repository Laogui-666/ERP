  ...
  return (
    <footer className="relative glass-navbar border-t border-glass-border-light glass-footer-animate">
      <div className="mx-auto max-w-6xl px-4 md:px-8 py-12 md:py-16">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          >
            ...
            <div className="mt-4 flex gap-3">
              {['微信', '微博'].map((name) => (
                <div key={name} className="flex h-9 w-9 items-center justify-center rounded-glass-sm glass-card text-xs text-glass-text-muted hover:bg-glass-bg-card transition-colors cursor-pointer">
                  {name[0]}
                </div>
              ))}
            </div>
          ...
          >
            <h4 className="text-xs font-semibold uppercase tracking-wider text-glass-text-muted mb-4">签证服务</h4>
          ...
          >
            <h4 className="text-xs font-semibold uppercase tracking-wider text-glass-text-muted mb-4">智能工具</h4>
            <ul className="space-y-3">
          ...
          >
            <h4 className="text-xs font-semibold uppercase tracking-wider text-glass-text-muted mb-4">关于</h4>
            <ul className="space-y-3">
        ...
        {/* 底部版权 */}
        <motion.div 
          className="mt-12 pt-8 glass-divider text-center"
          initial={{ opacity: 0 }}

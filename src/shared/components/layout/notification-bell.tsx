    ...
    <>
      ...
      {!hideTrigger && (
        <button
          ...
          disabled={loading}
          className="relative p-2 rounded-lg text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] hover:bg-white/[0.04] active:scale-90 transition-all duration-200 disabled:opacity-50"
        >
          {loading ? (
